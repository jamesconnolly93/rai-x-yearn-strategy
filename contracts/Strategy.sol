 ...
 *   There is an additional option to manually set position when allocation is suboptimal
 *
 ********************* */
...
contract Strategy is BaseStrategy {
    ...
    event BeforeWhile(uint256 amountWithdrawn, uint256 amount);
    ...
    //gives estimate of future APR with a change of debt limit. Useful for governance to decide debt limits
    ...
    function _withdrawSome(uint256 _amount) internal returns (uint256 amountWithdrawn) {
        ...
        while (amountWithdrawn < _amount) {
            ...
            emit BeforeWhile(amountWithdrawn, _amount);
